                                ...
                                <div class="card-body text-center">
                                    ...
                                    <h2 class="mb-0">
                                        <a href="{{route('eidentity.employee.list')}}">
                                            {{$overall_employees_counts['total_employees']}}
                                        </a>
                                    </h2>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-lg-4 mb-4">
                            <div class="card h-100">
                                <div class="card-body text-center">
                                    ...
                                    <h2 class="mb-0">
                                        {{($overall_employees_counts['total_employees_profile_pic_filled'])}}
                                    </h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-lg-4 mb-4">
                            <div class="card h-100">
                                <div class="card-body text-center">
                                    ...
                                    <h2 class="mb-0">
                                        {{($overall_employees_counts['total_employees_profile_pic_pending'])}}
                                    </h2>
                                </div>
                            </div>
                        </div>
