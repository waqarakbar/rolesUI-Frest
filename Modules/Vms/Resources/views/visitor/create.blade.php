                                    ...
                                    <div class="row border m-1">
                                        <div class="col-md-6">
                                            <div class="from-group">
                                                ...
                                                <input type=button class="btn btn-primary btn-sm" value="Profile" onClick="take_snapshot()">
                                    ...
                                    <div class="row border m-1">
                                        <div class="col-md-6">
                                            <div class="from-group">
                                                ...
                                                <input type=button class="btn btn-primary btn-sm" value=" Cnic Front" onClick="take_snapshot1()">
                                    ...
                                    <div class="row border m-1">
                                        <div class="col-md-6">
                                            <div class="from-group">
                                                ...
                                                <input type=button class="btn btn-primary btn-sm" value=" Cnic Back" onClick="take_snapshot2()">
