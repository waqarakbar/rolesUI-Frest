...
<body>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <th colspan="2">
                        {{ UcFirst($visitor->department()->exists() ? $visitor->department->title : '') }}
                    </th>
                </tr>
                {{-- <tr>
                    <th class="quantity">Gate</th>
                    <th colspan="2">{{ UcFirst($visitor->gate()->exists() ? $visitor->gate->name : '') }}</th>
                </tr> --}}
                <tr>
                    {{-- @dd($visitor->visitor_cnic) --}}
                    <th class="quantity">CNIC</th>
                    <th colspan="2">{{ UcFirst($visitor->visitor_cnic) }}</th>
                </tr>
                <tr>
    ...
    <a href="{{ route('visitors.index') }}" class="hidden-print">back</a>
    <script>
