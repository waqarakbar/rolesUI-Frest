            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    <div class="row align-items-end">
                        ...
                        <div class="col-6">
                            <img src="" width="140" height="150" class="rounded-start" alt="View Sales"
        ...
        <div class="col-lg-4 col-md-6 col-12 mb-4">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="dropdown">
                        <button class="btn p-0" type="button" id="visitsOptions" data-bs-toggle="dropdown"
                ...
                <div class="table-responsive">
                    <table class="table border-top">
                        ...
                        <tbody class="table-border-bottom-0">
                            <tr>
                                <td class="text-nowrap"><img src="{{ asset('assets/img/icons/brands/fastrack.png') }}"
                                        class="me-3" width="22" alt="Fastrack">Fastrack Watches</td>
                            ...
                            <tr>
                                <td><img src="{{ asset('assets/img/icons/brands/puma.png') }}" class="me-3"
                                        width="22" alt="Puma">Puma Shoes</td>
                                <td><i class="bx bx-trending-down text-danger me-2"></i>56.6%</td>
                                <td>$3,573</td>
                                <td>
                                    <div class="dropdown">
                                        <button class="btn p-0" type="button" id="action2" data-bs-toggle="dropdown"
                                            aria-haspopup="true" aria-expanded="false">
                                            <i class="bx bx-dots-vertical-rounded"></i>
                                        </button>
                            ...
                            <tr>
                                <td><img src="{{ asset('assets/img/icons/brands/nike.png') }}" class="me-3"
                                        width="22" alt="Nike">Nike Air Jordan</td>
                                <td><i class="bx bx-trending-up text-success me-2"></i>23.8%</td>
                                <td>$12,347</td>
                                <td>
                                    <div class="dropdown">
                                        <button class="btn p-0" type="button" id="action3" data-bs-toggle="dropdown"
                                            aria-haspopup="true" aria-expanded="false">
                                            <i class="bx bx-dots-vertical-rounded"></i>
                                        </button>
                            ...
                            <tr>
                                <td><img src="{{ asset('assets/img/icons/brands/oneplus.png') }}" class="me-3"
                                        width="22" alt="OnePlus">Oneplus 7 Pro</td>
                                <td><i class="bx bx-trending-up text-success me-2"></i>81.4%</td>
                                <td>$5,347</td>
                                <td>
                                    <div class="dropdown">
                                        <button class="btn p-0" type="button" id="action4" data-bs-toggle="dropdown"
                                            aria-haspopup="true" aria-expanded="false">
                                            <i class="bx bx-dots-vertical-rounded"></i>
                                        </button>
                            ...
                            <tr>
                                <td><img src="{{ asset('assets/img/icons/brands/google.png') }}" class="me-3"
                                        width="22" alt="Google">Google Pixal 6</td>
                                <td><i class="bx bx-trending-down text-danger me-2"></i>12.8%</td>
                                <td>$45,678</td>
                                <td>
                                    <div class="dropdown">
                                        <button class="btn p-0" type="button" id="action5" data-bs-toggle="dropdown"
                                            aria-haspopup="true" aria-expanded="false">
                                            <i class="bx bx-dots-vertical-rounded"></i>
                                        </button>
